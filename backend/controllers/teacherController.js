...
//       return { id: a._id, title: a.title, subject: a.subject.name, dueDate: a.dueDate, maxMarks: a.maxMarks, submissionsCount };
//     }));
//     res.json(result);
//   } catch (err) { res.status(500).json({ message: err.message }); }
// };
...
//     const hasAccess = student.subjects.some(s => teacher.subjects.some(t => t.toString() === s._id.toString()));
