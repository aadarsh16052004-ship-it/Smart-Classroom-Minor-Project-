...
const ACCENT = "#4f46e5";
const QUICK = ["How do I join a live attendance session?", "How do I submit an assignment?", "Where can I see my marks?", "How do I view lectures?", "What do the alert levels mean?", "How do I update my profile?"];
