...
// const input = { width: "100%", padding: "11px 14px", background: "rgba(30,41,59,0.8)", border: "1px solid rgba(245,158,11,0.2)", borderRadius: 8, color: "#e2e8f0", fontSize: 14, outline: "none", boxSizing: "border-box", fontFamily: "inherit" };
// const btn = (color = "#f59e0b") => ({ padding: "10px 20px", background: `linear-gradient(135deg, ${color}, ${color}88)`, border: "none", borderRadius: 8, color: "#fff", fontSize: 14, fontWeight: 600, cursor: "pointer" });
...
//           <StatCard icon="👥" label="Total Users" value={data?.users} color="#f59e0b" />
//           <StatCard icon="✅" label="Active Users" value={data?.activeUsers} color="#10b981" />
//           <StatCard icon="🎓" label="Students" value={data?.students} color="#3b82f6" />
//           <StatCard icon="📖" label="Teachers" value={data?.teachers} color="#6366f1" />
//           <StatCard icon="🖥️" label="Resources" value={data?.resources} color="#ec4899" />
//         </div>
//       )}
//     </Layout>
//   );
...
//                       </div>
//                       <span style={{ color: "#e2e8f0", fontSize: 14, fontWeight: 500 }}>{u.name}</span>
//                     </div>
//                   </td>
//                   <td style={{ padding: "14px 16px", color: "#64748b", fontSize: 13, borderBottom: "1px solid rgba(255,255,255,0.04)" }}>{u.email}</td>
//                   <td style={{ padding: "14px 16px", borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
...
//           <div style={card}>
//             <h3 style={{ color: "#94a3b8", fontSize: 13, textTransform: "uppercase", letterSpacing: "0.8px", margin: "0 0 18px" }}>Create Subject</h3>
...
//                   <div>
//                     <div style={{ color: "#e2e8f0", fontWeight: 600, fontSize: 15 }}>{s.name}</div>
...
//         <div style={{ display: "grid", gridTemplateColumns: "1fr 1.5fr", gap: 20, alignItems: "start" }}>
//           <div style={card}>
//             <h3 style={{ color: "#94a3b8", fontSize: 13, textTransform: "uppercase", letterSpacing: "0.8px", margin: "0 0 18px" }}>Add Entry</h3>
//             <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
...
//                 <div>
//                   <div style={{ color: "#e2e8f0", fontWeight: 600, fontSize: 14 }}>{t.subject?.name}</div>
...
//   const levelConfig = {
//     Emergency: { color: "#ef4444", bg: "rgba(239,68,68,0.08)", border: "rgba(239,68,68,0.3)", icon: "🚨" },
//     Warning: { color: "#f59e0b", bg: "rgba(245,158,11,0.08)", border: "rgba(245,158,11,0.3)", icon: "⚠️" },
//     Info: { color: "#3b82f6", bg: "rgba(59,130,246,0.08)", border: "rgba(59,130,246,0.3)", icon: "ℹ️" },
//   };
...
//         <div style={{ display: "grid", gridTemplateColumns: "1fr 1.5fr", gap: 20, alignItems: "start" }}>
//           <div style={card}>
//             <h3 style={{ color: "#94a3b8", fontSize: 13, textTransform: "uppercase", letterSpacing: "0.8px", margin: "0 0 18px" }}>Add Resource</h3>
//             <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
...
//                 <div style={{ color: "#e2e8f0", fontWeight: 600 }}>{r.name}</div>
...
//   const cardStyle = { background: "rgba(15,23,42,0.9)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: 24 };
//   const inputStyle = { padding: "10px 14px", background: "rgba(30,41,59,0.8)", border: "1px solid rgba(245,158,11,0.2)", borderRadius: 8, color: "#e2e8f0", fontSize: 14, outline: "none", fontFamily: "inherit" };

//   return (
//     <Layout navItems={adminNav}>
//       <PageHeader title="Enrollments" subtitle="Assign or remove subjects for students" />
//       {loading ? <div style={{ color: "#64748b", textAlign: "center", padding: 60 }}>Loading...</div> : (
//         <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
//           <input style={{ ...inputStyle, width: "100%", boxSizing: "border-box" }} placeholder="🔍 Search students by name, email or roll number..." value={search} onChange={e => setSearch(e.target.value)} />
...
//               {/* Student header */}
//               <div style={{ padding: "16px 22px", borderBottom: "1px solid rgba(255,255,255,0.06)", display: "flex", alignItems: "center", gap: 14 }}>
...
//                         borderRadius: 8,
//                         background: enrolled ? "rgba(16,185,129,0.1)" : "rgba(30,41,59,0.6)",
//                         border: `1px solid ${enrolled ? "rgba(16,185,129,0.3)" : "rgba(255,255,255,0.07)"}`,
//                       }}>
...
//                           style={{
//                             padding: "2px 8px", borderRadius: 6, fontSize: 11, fontWeight: 700, cursor: busy ? "not-allowed" : "pointer",
//                             background: enrolled ? "rgba(239,68,68,0.15)" : "rgba(16,185,129,0.15)",
//                             border: `1px solid ${enrolled ? "rgba(239,68,68,0.3)" : "rgba(16,185,129,0.3)"}`,
//                             color: enrolled ? "#ef4444" : "#10b981",
//                           }}>
...
//     <div style={{ background: "rgba(15,23,42,0.9)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 14, padding: "18px 20px", display: "flex", alignItems: "center", gap: 14 }}>
...
//         <div style={{ color: "#f0f4ff", fontSize: 24, fontWeight: 800, letterSpacing: "-1px" }}>{value ?? "—"}</div>
...
//         <StatBox icon="👥" label="Total Users" value={data?.users} color="#f59e0b" sub={`${data?.activeUsers} active`} />
//         <StatBox icon="🎓" label="Students" value={data?.students} color="#3b82f6" sub={data?.unenrolledStudents > 0 ? `${data.unenrolledStudents} unenrolled` : "All enrolled ✓"} />
//         <StatBox icon="📖" label="Teachers" value={data?.teachers} color="#10b981" />
//         <StatBox icon="📚" label="Subjects" value={data?.subjects} color="#6366f1" />
//         <StatBox icon="🖥️" label="Resources" value={data?.resources} color="#ec4899" sub={`${data?.availableResources} available`} />
//         <StatBox icon="🚨" label="Alerts Issued" value={data?.alerts} color="#ef4444" />
//       </div>

//       <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 20, marginBottom: 20 }}>

//         {/* Subject enrollment bar */}
//         <div style={{ background: "rgba(15,23,42,0.9)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: 22 }}>
//           <h3 style={{ color: "#94a3b8", fontSize: 12, textTransform: "uppercase", letterSpacing: "0.8px", margin: "0 0 18px" }}>Subject Enrollment</h3>
...
//                       <span style={{ color: "#e2e8f0", fontSize: 13 }}>{s.name} <span style={{ color: "#475569", fontSize: 11 }}>({s.code})</span></span>
...
//           <div style={{ background: "rgba(15,23,42,0.9)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: 20 }}>
//             <h3 style={{ color: "#94a3b8", fontSize: 12, textTransform: "uppercase", letterSpacing: "0.8px", margin: "0 0 14px" }}>Resource Status</h3>
//             <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
...
//           <div style={{ background: "rgba(15,23,42,0.9)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: 20, flex: 1 }}>
//             <h3 style={{ color: "#94a3b8", fontSize: 12, textTransform: "uppercase", letterSpacing: "0.8px", margin: "0 0 12px" }}>User Distribution</h3>
...
//       <div style={{ background: "rgba(15,23,42,0.9)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: 22 }}>
//         <h3 style={{ color: "#94a3b8", fontSize: 12, textTransform: "uppercase", letterSpacing: "0.8px", margin: "0 0 16px" }}>Recent Registrations</h3>
...
export function AdminEnrollments() {
  ...
  const cardStyle = { background: "rgba(15,23,42,0.9)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 16, padding: 24 };
  const inputStyle = { padding: "10px 14px", background: "rgba(30,41,59,0.8)", border: "1px solid rgba(245,158,11,0.2)", borderRadius: 8, color: "#e2e8f0", fontSize: 14, outline: "none", fontFamily: "inherit", width: "100%", boxSizing: "border-box" };
    ...
    <Layout navItems={adminNav}>
      ...
      {loading ? <div style={{ color: "#64748b", textAlign: "center", padding: 60 }}>Loading...</div> : (
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          {/* Tab switcher */}
          <div style={{ display: "flex", background: "rgba(15,23,42,0.8)", borderRadius: 12, padding: 4, border: "1px solid rgba(255,255,255,0.07)", maxWidth: 360 }}>
                  ...
                  <div style={{ padding: "16px 22px" }}>
                    ...
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                      {subjects.map(sub => {
                        ...
                        const busy = assigning === assignKey || assigning === removeKey;
                        return (
                          <div key={sub._id} style={{ display: "flex", alignItems: "center", gap: 8, padding: "6px 12px", borderRadius: 8, background: enrolled ? "rgba(16,185,129,0.1)" : "rgba(30,41,59,0.6)", border: `1px solid ${enrolled ? "rgba(16,185,129,0.3)" : "rgba(255,255,255,0.07)"}` }}>
                            <span style={{ color: enrolled ? "#10b981" : "#64748b", fontSize: 13 }}>{sub.name}</span>
                            <button onClick={() => enrolled ? remove(s._id, sub._id) : assign(s._id, sub._id)} disabled={busy}
          ...
          {tab === "csv" && (
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20, alignItems: "start" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                <div style={cardStyle}>
                  <h3 style={{ color: "#94a3b8", fontSize: 13, textTransform: "uppercase", letterSpacing: "0.8px", margin: "0 0 16px" }}>Step 1 — Select Subject</h3>
                ...
                <div style={cardStyle}>
                  <h3 style={{ color: "#94a3b8", fontSize: 13, textTransform: "uppercase", letterSpacing: "0.8px", margin: "0 0 8px" }}>Step 2 — Paste CSV Data</h3>
                  ...
                  <div style={{ padding: "10px 14px", background: "rgba(245,158,11,0.06)", borderRadius: 8, border: "1px solid rgba(245,158,11,0.15)", marginBottom: 12, fontSize: 12, color: "#94a3b8", fontFamily: "monospace", lineHeight: 1.8 }}>
                    email,rollNumber<br/>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                ...
                {csvPreview && !csvResult && (
                  <div style={cardStyle}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
                      <h3 style={{ color: "#94a3b8", fontSize: 13, textTransform: "uppercase", letterSpacing: "0.8px", margin: 0 }}>
                    ...
                    <div style={{ maxHeight: 280, overflowY: "auto", marginBottom: 14, display: "flex", flexDirection: "column", gap: 6 }}>
                      {csvPreview.map((row, i) => (
                        <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 12px", borderRadius: 8, background: "rgba(30,41,59,0.5)" }}>
                ...
                {csvResult && (
                  <div style={cardStyle}>
                    ...
                    <p style={{ color: "#64748b", fontSize: 13, margin: "0 0 16px" }}>Subject: <strong style={{ color: "#e2e8f0" }}>{csvResult.subjectName}</strong></p>
                    ...
                    {csvResult.details?.notFound?.length > 0 && (
                      <div style={{ padding: "10px 14px", background: "rgba(239,68,68,0.07)", borderRadius: 8, border: "1px solid rgba(239,68,68,0.2)" }}>
                        ...
                        {csvResult.details.notFound.map((e, i) => (
                          <div key={i} style={{ color: "#94a3b8", fontSize: 12 }}>{e}</div>
                        ))}
                      </div>
                    )}
